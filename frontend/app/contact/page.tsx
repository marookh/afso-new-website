        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:info@afsousa.org" className="text-blue-600 hover:text-blue-700">
                  info@afsousa.org
                </a>
              </div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/afghan-female-student-outreach-afsousa/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600" aria-label="LinkedIn">
              ...
              <a href="https://www.instagram.com/afghanfemalestudentoutreach/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" style={{ backgroundColor: '#135f5c' }}
            >
