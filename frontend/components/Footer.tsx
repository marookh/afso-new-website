    ...
    <footer className="bg-[#000000] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#3ba5c1]">AFSO</h3>
            <p className="text-sm text-[#5acbed]">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#3ba5c1]">Contact</h3>
            <ul className="space-y-2 text-sm">
              <li>Email: info@afsousa.org</li>
              <li>Phone: (555) 123-4567</li>
              <li className="pt-2">
                <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/afghan-female-student-outreach-afsousa/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="hover:text-[#5acbed] transition-colors" aria-label="LinkedIn">
              ...
              <a href="https://www.instagram.com/afghanfemalestudentoutreach/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
